  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end gap-3 justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-800">일정선택 보고서</h2>
        </div>
        <div className="flex flex-wrap items-end gap-2">
          ...
          <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700" onClick={handlePrint}>
            출력
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="py-3">
            <CardTitle className="text-lg">기간 요약</CardTitle>
          </CardHeader>
