...
<body>
    <div class="report-container">
        ...
        <div class="summary-section">
            <div class="summary">
                <h4>월간 요약</h4>
                <div class="summary-row"><span>지난달 이월금:</span><span class="amount">${formatAmount(lastMonthBalance)} ${currency}</span></div>
                ...
                <div class="summary-row"><span>월간 잔액:</span><span class="amount">${formatAmount(currentBalance)} ${currency}</span></div>
            </div>
